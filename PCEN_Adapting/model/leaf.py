...
def log_compression(inputs: torch.Tensor, epsilon=1e-6) -> torch.Tensor:
    "Log compression"
...
class Log_Compress(nn.Module):
    """
   Calculates the Log Compression of the input signal
   """
    def __init__(self):
        super(Log_Compress, self).__init__()
#
#         self.compression = log_compression()
#
    def forward(self, x):
